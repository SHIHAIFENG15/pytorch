...
instantiate_device_type_tests(TestExportRNN, globals(), only_for=("cuda", "xpu"))
instantiate_device_type_tests(TestExportTriton, globals(), except_for="cpu")
instantiate_device_type_tests(
    TestExportMoveToDeviceIndex, globals(), except_for="cpu"
)
instantiate_device_type_tests(
    TestExportAutocastException, globals(), except_for="cpu"
)
